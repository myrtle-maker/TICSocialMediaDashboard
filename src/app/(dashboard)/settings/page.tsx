          ...
          <div>
            ...
            <div className="flex gap-2">
              <input
                ...
                className="flex-1 rounded-lg border border-zinc-300 px-3 py-2 text-sm text-zinc-900 placeholder:text-zinc-400 focus:border-zinc-500 focus:outline-none focus:ring-1 focus:ring-zinc-500"
              />
        ...
        <CardContent className="space-y-4">
          <div className="grid gap-4 sm:grid-cols-2">
            <div className="rounded-lg border border-zinc-200 p-4">
              <p className="text-sm font-medium text-zinc-700">Frequency</p>
              <p className="text-xs text-zinc-500">
                How often new posts are fetched from each platform.
              </p>
              <div className="mt-3">
                <select className="w-full rounded-lg border border-zinc-300 px-3 py-2 text-sm text-zinc-900 focus:border-zinc-500 focus:outline-none focus:ring-1 focus:ring-zinc-500">
        ...
        <CardContent>
          <div className="grid gap-4 sm:grid-cols-3">
            <div className="rounded-lg bg-zinc-50 p-4 text-center">
              <HardDrive className="mx-auto mb-2 h-5 w-5 text-zinc-400" />
              <p className="text-sm font-medium text-zinc-700">
                Storage Mode
              </p>
            ...
            <div className="rounded-lg bg-zinc-50 p-4 text-center">
              <Shield className="mx-auto mb-2 h-5 w-5 text-zinc-400" />
              <p className="text-sm font-medium text-zinc-700">
                Data Privacy
              </p>
            ...
            <div className="rounded-lg bg-zinc-50 p-4 text-center">
              <RefreshCw className="mx-auto mb-2 h-5 w-5 text-zinc-400" />
              <p className="text-sm font-medium text-zinc-700">
                Last Refresh
              </p>
              <Badge variant="secondary" className="mt-1">
